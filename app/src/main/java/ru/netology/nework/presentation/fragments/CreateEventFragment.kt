...
class CreateEventFragment : Fragment() {
    ...
    private var selectedDateTime: Instant = Instant.now()
    ...
    private fun showDateTimePicker() {
        ...
        calendar.timeInMillis = selectedDateTime.toEpochMilli()

        DatePickerDialog(requireContext(), { _, year, month, dayOfMonth ->
            TimePickerDialog(requireContext(), { _, hourOfDay, minute ->
                calendar.set(year, month, dayOfMonth, hourOfDay, minute)
                selectedDateTime = calendar.time.toInstant()
                updateDateTimeDisplay()
    ...
    private fun updateDateTimeDisplay() {
        binding.selectedDate.text = dateFormatter.format(selectedDateTime)
    }
